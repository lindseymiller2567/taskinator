...
var taskFormHandler = function (event) {
  ...
  // resets the the form so that the values the user typed in go away after clicking 'add task' button
  formEl.reset();
...
var createTaskEl = function (taskDataObj) {
  ...
  // add the div content to li
  listItemEl.appendChild(taskInfoEl);

  taskDataObj.id = taskIdCounter;
  // .push adds any content between the parentheses to the end of the specified array
  ...
  // add entire list (li) item to list (ul)
  tasksToDoEl.appendChild(listItemEl);
...
// convert tasks from string format back to an array of objects
